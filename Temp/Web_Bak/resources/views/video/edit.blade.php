...
<form class="" action="{{ route('video.update', ['video' => $video->id]) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
    ...
    <div class="form-row">
        <div class="form-group w-50">
            ...
            <div class="col">
                <input type="text" name="name" class="form-control" id="name" aria-describedby="name_label" required="required" value="{{ $video->name }}"/>
            </div>
        </div>
    </div>
    ...
    <div class="form-row">
        <div class="form-group w-50">
            ...
            <div class="col">
                <input type="text" name="video_uri" class="form-control" id="video_uri" aria-describedby="video_uri_label" required="required" value="{{ $video->video_uri }}"/>
            </div>
        </div>
    </div>
    ...
    <div class="form-row">
        <div class="form-group w-50">
            ...
            <div class="col">
                <textarea name="description" class="form-control" id="description" aria-describedby="description_label">{{ $video->description }}</textarea>
            </div>
        </div>
    </div>
